              ...
              <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="user/info/Intro_Com.html">회사 소개</a>
                        <a class="dropdown-item" href="user/info/Intro_Map.html">오시는길</a>
                    </div>
                  </li>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="user/support/sup_FAQ.jsp">공지사항</a>
                        <a class="dropdown-item" href="user/support/sup_FAQ">자주 묻는 질문</a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <button type="button" class="btn btn-primary" onclick="location.href='user/basic/login.html'">로그인</button>
                </div>

...
<% 
	...
	String confmKey = "devU01TX0FVVEgyMDIwMTAzMDEyMjEyNjExMDM0ODc="; // 검색API 승인키
...
<script language="javascript">
	...
	function setParent(){
		...
		opener.jusoCallBack(rtRoadFullAddr, rtSiNm, rtSggNm);
		...
		<div class="pop-address-search" style="width: 100%;" >
			...
			<div style="height: 365px;" id="searchContentBox">
				<fieldset>
					...
					<span class="wrap">
						<input type="text" class="popSearchInput form-control" style="font-size: 13px; ime-mode:active; border: 1px solid #ced4da; color: #495057; font-family: "Noto Sans KR", sans-serif; !important"  title="검색어를 입력하세요" name="keyword" id="keyword" placeholder="도로명주소, 건물명 또는 지번입력" value=""  tabindex="1"/>
				...
				<!-- //상세주소 입력 -->
			<div class="logo" style="display: block;" >MASURI</div>
			</div>
		</div>
		</form>
</body>
